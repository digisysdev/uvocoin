...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Uvocoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"uvocointools.com", "149.28.26.116"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"uvocointools.com", "testnet-seed.uvocointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Uvocoin is probably already running."), addrBind.ToString().c_str());
        else
